...
class App(asynctk.AsyncTk):
    ...
    def prepare_session_paths(self, base_name=None):
    ...
    def prepare_project_paths(self, base_name, source_path=''):
        """
    ...
    async def export(self):
        ...
        try:
            await asyncio.to_thread(timelapse.export, progress_kill_check, export_time_limit, export_preview_last_frame, export_preview_duration, export_final_frame_duration, export_fps, frames_path, container, codec, output_path)
